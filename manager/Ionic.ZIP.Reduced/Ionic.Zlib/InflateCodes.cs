...
internal sealed class InflateCodes
{
	...
	internal int Process(InflateBlocks blocks, int r)
	{
		...
		num = blocks.bitb;
		num2 = blocks.bitk;
		int num5 = blocks.write;
		int num6 = ((num5 < blocks.read) ? (blocks.read - num5 - 1) : (blocks.end - num5));
		while (true)
		{
			switch (mode)
			{
			case 0:
				if (num6 >= 258 && num4 >= 10)
				{
					...
					num2 = blocks.bitk;
					num5 = blocks.write;
					num6 = ((num5 < blocks.read) ? (blocks.read - num5 - 1) : (blocks.end - num5));
					if (r != 0)
					{
						mode = ((r == 1) ? 7 : 9);
						break;
			...
			case 1:
			{
				...
				num = SharedUtils.URShift(num, tree[num8 + 1]);
				num2 -= tree[num8 + 1];
				int num9 = tree[num8];
				if (num9 == 0)
				{
			...
			case 5:
			{
				...
				while (len != 0)
				{
					if (num6 == 0)
					{
						if (num5 == blocks.end && blocks.read != 0)
						{
							num5 = 0;
							num6 = ((num5 < blocks.read) ? (blocks.read - num5 - 1) : (blocks.end - num5));
						}
