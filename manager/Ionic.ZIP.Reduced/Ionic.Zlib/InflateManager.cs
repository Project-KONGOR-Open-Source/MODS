	...
	internal int Inflate(FlushType flush)
	{
		...
		while (true)
		{
			...
			case 3:
				...
				_codec.AvailableBytesIn--;
				_codec.TotalBytesIn++;
				need += (long)((ulong)((_codec.InputBuffer[_codec.NextIn++] & 0xFF) << 16) & 0xFF0000uL);
				mode = 4;
				goto case 4;
			case 4:
				if (_codec.AvailableBytesIn == 0)
				...
				_codec.AvailableBytesIn--;
				_codec.TotalBytesIn++;
				need += (long)((ulong)((_codec.InputBuffer[_codec.NextIn++] & 0xFF) << 8) & 0xFF00uL);
				mode = 5;
				goto case 5;
			case 5:
				if (_codec.AvailableBytesIn == 0)
				...
				_codec.AvailableBytesIn--;
				_codec.TotalBytesIn++;
				need += (long)((ulong)_codec.InputBuffer[_codec.NextIn++] & 0xFFuL);
