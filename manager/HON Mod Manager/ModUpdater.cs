...
public class ModUpdater
{
    ...
    private void UpdateThread()
    {
        ...
        try
        {
            ...
            HttpWebRequest myWebRequest = (HttpWebRequest)WebRequest.Create(FixHTTPURL(Mod.UpdateCheck));
            ...
            FileStream myFileStream = new FileStream(Mod.File, FileMode.Create);
            myFileStream.Write(m_bytes, 0, m_size);
            myFileStream.Close();

            Status = ModUpdaterStatus.UpdateDownloaded;
        }
        catch { Status = ModUpdaterStatus.Failed; }
    }
}
